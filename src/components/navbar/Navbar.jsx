            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h3 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}><img class="h-6 w-15 sm:h-5 w-115 mx-5 " src='https://res.cloudinary.com/dt8emxboh/image/upload/v1701076593/hhwyldfpkg6cz20zk4ap.png'></img></h3>
                  </div>
                </Link>
              </div>
