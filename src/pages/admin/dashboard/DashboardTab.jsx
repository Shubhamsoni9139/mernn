...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, order, user, coupon ,deleteCoupon} = context;
                ...
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " >
                        <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
                            ...
                            <Tab>
                                <button type="button"  className="font-medium border-b-2 border-blue-500 bg-[#605d5d12] text-blue-500 rounded-lg text-xl  hover:shadow-blue-700 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]   px-7 py-1.5 text-center ">
                                    <div className="flex gap-2 items-center">
                                        <AiFillShopping /> Coupons
                                    </div>
                                </button>
                            </Tab>
                        </TabList>
                    ...
                    <td className="px-6 py-4 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
                      {quantity}
                        ...
                        <TabPanel>
                            {/* Coupons Tab Panel */}
                            <div className="relative overflow-x-auto mb-10">
                                <h1 className='text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Coupon Details</h1>
                                <div className=" flex justify-end">
                                    <button
                                        onClick={addcoupon}
                                        type="button"
                                        className="focus:outline-none text-white bg-blue-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                            Add Coupon <AiFillShopping /> 
                                        </div></button>
                                </div>
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-black uppercase bg-gray-200" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '' }}>
