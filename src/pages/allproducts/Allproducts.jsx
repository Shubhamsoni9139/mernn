  ...
  return (
    <Layout>
      ...
      <section className="text-gray-600 body-font">
            ...
            <span className="text-sm text-slate-900 line-through">₹{price*1.2}</span>
                                </p>
                      
                                <div className=" flex justify-center">
                                                                  <button type="button" 
                                                                  onClick={()=> addCart(item)}
                                                                  className="flex items-center rounded-md bg-slate-900 px-10 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"><svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
